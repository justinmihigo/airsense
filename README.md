...
- **Real-time Air Quality Monitoring**: Track various air quality metrics including PM2.5, PM10, CO2, temperature, and humidity.
...
- **Multiple Device Support**: Conn
ect and manage multiple sensors across different locations.

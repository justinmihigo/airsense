    ...
    <AppLayout>
      <div className="bg-[#F6F6FA] min-h-screen p-8">
        <div className="max-w-2xl mx-auto">
          <h2 className="text-2xl font-semibold text-green-600 mb-8">Add New Device</h2>
          <form onSubmit={handleSubmit} className="bg-white rounded-xl shadow p-8">
            ...
            <button
              type="submit"
              disabled={processing}
              className="w-full py-2 rounded-full bg-[#6C2BD7] text-white font-semibold text-lg hover:bg-[#4B1A9A] disabled:opacity-50"
            >
              {processing ? 'Adding Device...' : 'Add Device'}
            </button>
          </form>
        </div>
      </div>
